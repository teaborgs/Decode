...
public class Auto_RED_Far_9_human extends BaseOpMode {
	...
	// PASTREZ directia ta (-1.0) ca sa nu-ti inverseze turret-ul
	...
	/** Wait pana cand avgRPM e aproape de target (ca in Far_9), cu timeout. */
	...
	protected void OnRun() {
		...
		// ===== PATHS (exact cum ai in Far_9_human) =====
		...
		Actions.runBlocking(
				RunInParallel(
						...
						RunSequentially(
								...
								// ===== SHOOT 3 =====
								RunInParallel(
										HumanToStart2, // pastrez exact cum ai tu
										packet -> { shooterRpmCmd = 4800; return shooter_on.run(packet); }
								),
								waitUntilShooterRpm(4800, 150, 800),
