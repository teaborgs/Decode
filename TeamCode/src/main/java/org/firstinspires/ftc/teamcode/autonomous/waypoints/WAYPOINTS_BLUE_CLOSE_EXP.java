...
public class WAYPOINTS_BLUE_CLOSE_EXP
{
	public static final Pose2d START =
			new Pose2d(0.0, 0.0, Math.toRadians(0));

	public static final Pose2d SHOOT =
			new Pose2d(29.2, 50.0, Math.toRadians(0));

	public static final Pose2d PICKUP1 =
			new Pose2d(-11.8, 50.0, Math.toRadians(0));

	public static final Pose2d OPENGATE =
			new Pose2d(-12.78, 62.91, Math.toRadians(0));

	public static final Pose2d OPENGATES =
			new Pose2d(-7.34, 62.91, Math.toRadians(0));

	public static final Pose2d PICKUP2S =
			new Pose2d(11, 73, Math.toRadians(0));  //inceput pickup preventiv

	public static final Pose2d PICKUP2 =
			new Pose2d(-19.4, 73, Math.toRadians(0));

	public static final Pose2d FINISHLINE =
			new Pose2d(29, 73, Math.toRadians(0));

	public static final Pose2d SHOOT_EXP =
			new Pose2d(-19.4, 0, Math.toRadians(0));
	...
	public static final Pose2d PICKUP3 =
			new Pose2d(-15.44, 97.37, Math.toRadians(0));

	public static final Pose2d PICKUP3S =
			new Pose2d(12.40, 97.37, Math.toRadians(0));
}
