...
@TeleOp(name = "🎯Gate Aim Turret TEST (V3)🎯", group = "TeleOp")
public final class GateAimTurretTestV3 extends BaseOpMode {
	...
	// deadzone cu hysteresis (ca la decodeBLUE)
	private static final double LL_DZ_STOP  = 2.0; // dacă intră sub -> aligned
	private static final double LL_DZ_START = 3.0; // dacă trece peste -> iese din aligned

	// “step” în grade pe update, din tx (și clamp)
	private static final double LL_DEG_PER_TX = 1.0; // tune
	private static final double LL_MAX_STEP_DEG = 8.0;
	...
	// semn pentru tx -> direcție turret (NU e neapărat MOTOR_SIGN)
	// dacă vezi că se mișcă invers, schimbă la -1
