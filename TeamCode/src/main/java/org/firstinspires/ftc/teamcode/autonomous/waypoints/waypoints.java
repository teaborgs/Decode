...
public class waypoints
{
	...
	public static final Pose2d PICKUP1    = new Pose2d(23.63, 23.80, Math.toRadians(90));
	public static final Pose2d PARK       = new Pose2d(24.67, 29.47, Math.toRadians(1.0));
	public static final Pose2d FPICKUP1   = new Pose2d(22.8, 43.29, Math.toRadians(88));
