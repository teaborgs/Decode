...
public class Auto_Blue_Far_12 extends BaseOpMode {
    ...
    protected void OnRun() {
        ...
        Action backToStart = robot.drivetrain.actionBuilder(WAYPOINTS_BLUE_FAR.START, backstartAccel)
                .setTangent(Math.toRadians(90))
                .lineToY(WAYPOINTS_BLUE_FAR.START.position.y)
                .build();

        Action backToStart2 = robot.drivetrain.actionBuilder(WAYPOINTS_BLUE_FAR.START, backstartAccel)
                .setTangent(Math.toRadians(90))
                .lineToY(WAYPOINTS_BLUE_FAR.START.position.y)
                .build();
