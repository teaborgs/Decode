...
@TeleOp(name = "🔵🔵zbor-mi-l🔵🔵", group = "TeleOp")
public final class decodeZBOR extends BaseOpMode {
	...
	private double shooterTargetRpm = 6000;
	private final double shooterTargetRpmNear = 6000;
	private final double shooterTargetRpmFar = 6000;
	...
	private static final int CUP_RUMBLE_MS = 6000;
